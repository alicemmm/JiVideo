package xvideo.ji.com.jivideo.download;
...
public class DownloadManager {
    ...
    public DownloadInfo getCurrentDownloadInfo(int adid) {
...
//                    .setProgress(fileSize, complete, false)
    ...
    public void resumeDownload(int index, final RequestCallBack<File> callback) throws DbException {
        final DownloadInfo downloadInfo = mDownloadInfoList.get(index);
    ...
    public void removeDownload(int index) throws DbException {
        DownloadInfo downloadInfo = mDownloadInfoList.get(index);
    ...
    public class ManagerCallBack extends RequestCallBack<File> {
        ...
        private ManagerCallBack(DownloadInfo jiDownloadInfo, RequestCallBack<File> baseCallBack) {
            this.baseCallBack = baseCallBack;
        ...
        public void onLoading(long total, long current, boolean isUploading) {
            ...
            if (mShowNotify) {
                ...
                try {
                    notifyCompat.builder.setContentText(Utils.formatSize(current) + "/" +
