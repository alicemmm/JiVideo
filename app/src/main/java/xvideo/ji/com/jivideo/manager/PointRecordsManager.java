...
public class PointRecordsManager {
    private static final String TAG = PointRecordsManager.class.getSimpleName();
    ...
    public PointRecordsManager(Context mContext, onResponseListener mListener) {
        this.mContext = mContext;
        this.mListener = mListener;
    }

    public PointRecordsManager(Context mContext) {
        this.mContext = mContext;
    }
    ...
    public void req() {
        ...
        mRequest = new StringRequest(Request.Method.POST, Consts.GET_POINT_RECORD,
